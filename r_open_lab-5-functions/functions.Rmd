...
## Introduction
Learning to write functions will really pay off as your data science becomes more complex. Functions let you automate your coding tasks and keep them organized, and help you write code that is easier to maintain (and that has fewer bugs and errors!).
...
There's a subtle bug in this code, but it runs fine. If you take a look at the line starting with b = , you can see that we are taking the minimum of a rather than b. This is a copy/paste error, and it caused a difficult bug in our code!
...
Next, we will spend the rest of the session working on exercises to practice creating functions. Please let me know if you have any questions, and open exercises.Rmd to get started!
